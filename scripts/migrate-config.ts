...
async function migrate() {
    ...
    await Bun.write(join(backupDir, 'README.txt'), 'Backup of legacy JSON configs before migration to system.yaml');

    // We won't delete them yet, just to be safe. User can delete manually.
    console.log('Note: Legacy JSON files were NOT deleted. You can remove them after verification.');
}
